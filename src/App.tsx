  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/financeiro/extrato" element={<Suspense fallback={<PageLoader />}><FinanceiroExtratoPage /></Suspense>} />
        <Route path="/financeiro/dashboard" element={<Suspense fallback={<PageLoader />}><FinanceiroDashboardPage /></Suspense>} />
