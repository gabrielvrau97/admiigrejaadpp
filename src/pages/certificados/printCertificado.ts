  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .header{
      ...
      padding-bottom:6mm;
      border-bottom:0.5mm solid #dbeafe;
      margin-bottom:10mm;
      position:relative;z-index:2;
    }
    .header img{height:22mm;width:auto}
    .header .titles h1{
      font-size:7mm;font-weight:bold;color:#1d4ed8;
      letter-spacing:0.5mm;text-transform:uppercase;line-height:1;
    }
    ...
    .cert-label{
      font-size:6mm;color:#6b7280;letter-spacing:3mm;
      text-transform:uppercase;margin-bottom:4mm;font-weight:600;
    }

    .cert-title{
      font-size:16mm;font-weight:bold;color:#1d4ed8;
      letter-spacing:2mm;text-transform:uppercase;line-height:1;
      margin-bottom:8mm;
      font-family:Georgia,serif;
    }

    .body-text{
      font-size:5mm;line-height:1.6;color:#1f2937;margin-bottom:4mm;
    }

    .aluno-name{
      font-size:11mm;font-weight:bold;color:#111;
      margin:5mm 0;
      font-style:italic;
      font-family:Georgia,serif;
    }
    ...
    .details{
      display:flex;justify-content:center;gap:10mm;margin-top:6mm;
      font-size:4mm;color:#4b5563;
    }
    ...
    .sign-line{
      border-top:0.5mm solid #1f2937;
      padding-top:2mm;
      font-size:3.5mm;font-weight:bold;color:#1f2937;
    ...
    <div class="no-print" style="margin-bottom:14px;display:flex;align-items:center;gap:8px;background:#fff7ed;border:1px solid #fdba74;border-radius:6px;padding:8px 12px;max-width:1000px;margin-left:auto;margin-right:auto">
      <span style="font-size:12px;color:#c2410c;font-weight:600">🏆 Certificado — ${c.nome_aluno}</span>
      <button onclick="window.print()" style="background:#c2410c;color:white;border:none;padding:6px 16px;border-radius:5px;cursor:pointer;font-size:12px;margin-left:auto">🖨️ Imprimir</button>
